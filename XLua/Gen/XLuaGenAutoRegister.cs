...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit10(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(XDebug.Helper), XDebugHelperWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(XDebug.Icon), XDebugIconWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(XDebug.Location), XDebugLocationWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(XDebug.Orient), XDebugOrientWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(XDebug.Module), XDebugModuleWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(XDebug.Modules), XDebugModulesWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(XDebug.XLog), XDebugXLogWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(XDebug.XLogView), XDebugXLogViewWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(XDebug.Location.Align), XDebugLocationAlignWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(XDebug.Module.Type), XDebugModuleTypeWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(XDebug.XLog.MyInfo), XDebugXLogMyInfoWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(XDebug.XLog.LogLevel), XDebugXLogLogLevelWrap.__Register);
...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate int __GEN_DELEGATE1( UnityEngine.ParticleSystem ps);
		
		delegate int __GEN_DELEGATE2( UnityEngine.ParticleSystem ps,  UnityEngine.GameObject go,  System.Collections.Generic.List<UnityEngine.ParticleCollisionEvent> collisionEvents);
		
		delegate int __GEN_DELEGATE3( UnityEngine.ParticleSystem ps,  UnityEngine.ParticleSystemTriggerEventType type);
		
		delegate int __GEN_DELEGATE4( UnityEngine.ParticleSystem ps,  UnityEngine.ParticleSystemTriggerEventType type,  System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle> particles);
		
		delegate void __GEN_DELEGATE5( UnityEngine.ParticleSystem ps,  UnityEngine.ParticleSystemTriggerEventType type,  System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle> particles,  int offset,  int count);
		
		delegate void __GEN_DELEGATE6( UnityEngine.ParticleSystem ps,  UnityEngine.ParticleSystemTriggerEventType type,  System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle> particles);
		
		delegate UnityEngine.PhysicsScene __GEN_DELEGATE7( UnityEngine.SceneManagement.Scene scene);
		
		delegate UnityEngine.PhysicsScene2D __GEN_DELEGATE8( UnityEngine.SceneManagement.Scene scene);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(UnityEngine.ParticleSystem), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE1(UnityEngine.ParticlePhysicsExtensions.GetSafeCollisionEventSize)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE2(UnityEngine.ParticlePhysicsExtensions.GetCollisionEvents)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE3(UnityEngine.ParticlePhysicsExtensions.GetSafeTriggerParticlesSize)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE4(UnityEngine.ParticlePhysicsExtensions.GetTriggerParticles)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE5(UnityEngine.ParticlePhysicsExtensions.SetTriggerParticles)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE6(UnityEngine.ParticlePhysicsExtensions.SetTriggerParticles)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(UnityEngine.SceneManagement.Scene), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE7(UnityEngine.PhysicsSceneExtensions.GetPhysicsScene)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE8(UnityEngine.PhysicsSceneExtensions2D.GetPhysicsScene2D)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,

    ...
    public class UnityEngineCameraWrap 
    {
        ...
        static int _g_get_renderingPath(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Camera gen_to_be_invoked = (UnityEngine.Camera)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineRenderingPath(L, gen_to_be_invoked.renderingPath);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_actualRenderingPath(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Camera gen_to_be_invoked = (UnityEngine.Camera)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineRenderingPath(L, gen_to_be_invoked.actualRenderingPath);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_transparencySortMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Camera gen_to_be_invoked = (UnityEngine.Camera)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineTransparencySortMode(L, gen_to_be_invoked.transparencySortMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_stereoTargetEye(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Camera gen_to_be_invoked = (UnityEngine.Camera)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineStereoTargetEyeMask(L, gen_to_be_invoked.stereoTargetEye);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;

    ...
    public class UnityEngineCustomRenderTextureWrap 
    {
        ...
        static int _g_get_initializationSource(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.CustomRenderTexture gen_to_be_invoked = (UnityEngine.CustomRenderTexture)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineCustomRenderTextureInitializationSource(L, gen_to_be_invoked.initializationSource);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_updateMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.CustomRenderTexture gen_to_be_invoked = (UnityEngine.CustomRenderTexture)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineCustomRenderTextureUpdateMode(L, gen_to_be_invoked.updateMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_initializationMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.CustomRenderTexture gen_to_be_invoked = (UnityEngine.CustomRenderTexture)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineCustomRenderTextureUpdateMode(L, gen_to_be_invoked.initializationMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_updateZoneSpace(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.CustomRenderTexture gen_to_be_invoked = (UnityEngine.CustomRenderTexture)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineCustomRenderTextureUpdateZoneSpace(L, gen_to_be_invoked.updateZoneSpace);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;

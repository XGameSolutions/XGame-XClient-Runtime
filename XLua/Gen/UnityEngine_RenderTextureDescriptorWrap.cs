    ...
    public class UnityEngineRenderTextureDescriptorWrap 
    {
        ...
        static int _g_get_colorFormat(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.RenderTextureDescriptor gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineRenderTextureFormat(L, gen_to_be_invoked.colorFormat);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_vrUsage(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.RenderTextureDescriptor gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineVRTextureUsage(L, gen_to_be_invoked.vrUsage);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_flags(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.RenderTextureDescriptor gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineRenderTextureCreationFlags(L, gen_to_be_invoked.flags);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_memoryless(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.RenderTextureDescriptor gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineRenderTextureMemoryless(L, gen_to_be_invoked.memoryless);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
